...
export default function Swap({ history }: RouteComponentProps) {
  ...
  const maxInputAmount: CurrencyAmount | undefined = maxAmountSpend(
  ...
  const priceImpactSeverity = useMemo(() => {
    const executionPriceImpact = trade
      ? computePriceImpactWithMaximumSlippage(trade, allowedSlippage)
      : undefined;
